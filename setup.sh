...
aws s3 cp s3://apache-buck-05/setup-play.yaml /home/ec2-user/setup-play.yaml
aws s3 cp s3://apache-buck-05/index.html /home/ec2-user/index.html
aws s3 cp s3://apache-buck-05/config.json /home/ec2-user/config.json
